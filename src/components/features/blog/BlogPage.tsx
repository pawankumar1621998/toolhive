...
const POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    title: "How to Create a Professional Cover Letter in 2 Minutes",
    excerpt: "AI-powered cover letter generator. Free templates, no signup, download as PDF.",
    category: "Tutorials",
    author: { name: "Priya Sharma", initial: "P", color: "bg-violet-500" },
    date: "Jun 8, 2026",
    readTime: "5 min read",
    ...
    trending: true,
    tags: ["Cover Letter", "Resume", "AI"],
  },
  {
    id: "7",
    slug: "body-fat-calculator-india-guide",
    title: "Body Fat Calculator India: Accurate US Navy Method",
    excerpt: "Calculate body fat percentage using US Navy formula. Free calculator with gender-specific formulas.",
    category: "Tutorials",
    author: { name: "Marcus Lee", initial: "M", color: "bg-cyan-500" },
    date: "Jun 7, 2026",
    readTime: "4 min read",
  ...
  {
    id: "8",
    slug: "pdf-to-image-converter-guide",
    title: "Convert PDF to Image: Free Online Converter Guide",
    excerpt: "Convert PDF to JPG PNG. No signup, no watermark, 100% free online tool.",
    category: "Tips & Tricks",
    author: { name: "Alex Chen", initial: "A", color: "bg-emerald-500" },
    date: "Jun 6, 2026",
    readTime: "3 min read",
    ...
    trending: true,
    tags: ["PDF", "Converter", "Images"],
  },
  {
    id: "9",
    slug: "speech-to-text-online-guide",
    title: "Speech to Text: Transcribe Audio Free Online",
    excerpt: "Convert voice to text with AI. Supports 50+ languages. Transcribe meetings, interviews, podcasts.",
    category: "Tutorials",
    author: { name: "Sofia Garcia", initial: "S", color: "bg-rose-500" },
    date: "Jun 5, 2026",
    readTime: "4 min read",
    headerGradient: "from-pink-500 to-rose-600",
    tags: ["Speech", "Transcribe", "AI"],
  },
  {
    id: "10",
    slug: "ai-note-maker-guide",
    title: "AI Note Maker: Generate Smart Notes from Any Text",
    excerpt: "Create smart notes from articles or text. Free AI note generator organizes content into structured notes.",
    category: "Tips & Tricks",
    author: { name: "Jordan Kim", initial: "J", color: "bg-amber-500" },
    date: "Jun 4, 2026",
    readTime: "3 min read",
